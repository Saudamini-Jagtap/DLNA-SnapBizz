...
//					break;
	...
	public static void setContentPageSelected(){
		mContentRb.setChecked(true);
	}
//	public static void setControlPageSelected(){
//		mControlRb.setChecked(true);
//	}
	public static void setDevicePageSelected(){
		mDeviceRb.setChecked(true);
	}
	public static void setSettingsPageSelected(){
		mSettingsRb.setChecked(true);
	}
}
