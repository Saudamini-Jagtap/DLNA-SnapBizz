...
public class SettingActivity extends PreferenceActivity {
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
		...
		else if(preference.getKey().equals("media_player") || preference.getKey().equals("media_server") ){
			IndexActivity.setDevicePageSelected();
		}
	...
	public static String getRegisterdMediaPlayer(Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		return prefs.getString("media_player", " ");
	}

	public static String getRegisterdMediaServer(Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		return prefs.getString("media_server", " ");
	}
